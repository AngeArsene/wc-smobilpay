...
if (! class_exists('WC_Gateway_Orange_Money')) {
        ...
        public function init_form_fields()
        {
            $this->form_fields = array(
                ...
                'description' => array(
                    ...
                    'default' => 'Pay securely with your Orange Money account',
                ),
                'merchant_key' => array(
                    'title' => 'Merchant Key',
                    'type' => 'text',
...
<?php
        ...
        {
            if (empty($_POST['orange_phone_number'])) {
        ...
        public function process_payment($order_id)
        {
            ...
            update_post_meta($order_id, '_orange_phone_number', $phone);
            ...
            if ($status === 'PENDING') {
                $order->update_status('pending', 'Awaiting Orange Money payment confirmation');
